...
class Master_window:
    ...
    def __init__(self, master):
        ...
        tk.Checkbutton(self.geo_frame, text=': Subtract Wall Plates from Height (y/n)', variable=self.sub_plates).grid(row=3, column=4, sticky=tk.W)
        ...
        self.b_build_chart = tk.Button(self.input_frame,text="Build P-Lateral Pressure Chart", command=self.generate_interaction_graph, font=helv, state = tk.NORMAL)
        self.b_build_chart.pack(side=tk.RIGHT)
        self.b_build_pm = tk.Button(self.input_frame,text="Build P-M Chart", command=self.generate_pm_graph, font=helv, state = tk.NORMAL)
        ...
        self.b_output_res= tk.Button(self.results_frame,text="Export Results", command=self.write_text_results_to_file, font=helv, state = tk.NORMAL)
        self.b_output_res.pack(side=tk.RIGHT)
        self.b_output_pp= tk.Button(self.results_frame,text="Export P-Pressure Curves", command=self.print_pp_graph_common, font=helv, state = tk.NORMAL)
        self.b_output_pp.pack(side=tk.RIGHT)
        self.b_output_pm= tk.Button(self.results_frame,text="Export P-M Curves", command=self.print_pm_graph_common, font=helv, state = tk.NORMAL)
        ...
        self.nb.add(self.page2, text='P-Lateral Pressure Diagram', state = tk.NORMAL)
        ...
        self.nb.add(self.page3, text='P-M Diagram', state = tk.NORMAL)
        ...
        self.nb.add(self.page4, text='P-M Diagram - Stud', state = tk.NORMAL)
        ...
        self.nb.add(self.page5, text='User Loads', state = tk.NORMAL)
        ...
        self.b_save = tk.Button(self.base_frame,text="Save Inputs", command=self.save_inputs, font=helv, state = tk.NORMAL)
