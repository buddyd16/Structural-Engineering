...
plt.plot(M_collins_plot,P_collins_plot,'r--')
plt.plot([i*j for i,j in zip(M_collins_plot,aci_reduction)],[i*j for i,j in zip(P_collins_plot,aci_reduction)],'r-')
plt.plot(M_desayi_plot,P_desayi_plot,'g--')
plt.plot([i*j for i,j in zip(M_desayi_plot,aci_reduction)],[i*j for i,j in zip(P_desayi_plot,aci_reduction)],'g-')
plt.plot(M_whitney_plot,P_whitney_plot,'b--')
plt.plot([i*j for i,j in zip(M_whitney_plot,aci_reduction)],[i*j for i,j in zip(P_whitney_plot,aci_reduction)],'b-')
plt.plot([0,max(M_desayi_plot)],[0,0],'k-')
